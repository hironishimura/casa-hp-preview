...
1. **お客さまが `wordpress/designcasa-shome-lite.zip`（2.6MB）を d-casa.jp にアップロード**
   手順は `WordPressへの設置手順.md` に記載。所要10〜15分。
2. 設置後、表示崩れや不具合の報告を受けて修正 → 再ビルド → 再デプロイ
