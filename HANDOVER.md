...
| 項目 | 状態 |
|---|---|
| WordPressテーマ `designcasa-shome` | **完成**（v1.4.3） |
...
| **d-casa.jp への設置** | **設置済み**（**v1.4.2 が稼働中**。v1.4.3 への入れ替えは急ぎではない） |
